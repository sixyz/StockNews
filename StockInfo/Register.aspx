<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="StockInfo.Register" %>
...
<body>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        ...
        <p class="help-block">6-12 characters. No whitespace allowed</p>
      </div>
    </div>
    ...
    <div class="control-group">
      <!-- Button -->
      <div class="controls">
          <asp:Button ID="btnRegisterUser" class="btn btn-success" runat="server" Text="Register" OnClick="btnRegisterUser_Click" />
      </div>
    </div>
        </div>
        </div>
